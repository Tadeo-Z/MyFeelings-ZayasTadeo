package zayas.tadeo.myfeelings
...
import zayas.tadeo.myfeelings.utilities.CustomBarDrawable
import zayas.tadeo.myfeelings.utilities.CustomCircleDrawable
import zayas.tadeo.myfeelings.utilities.Emociones
import zayas.tadeo.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!data) {
            ...
            graphHappy.background = CustomBarDrawable(this, Emociones("Feliz", 0.0F, R.color.mustard, happy))
            graphNeutral.background = CustomBarDrawable(this, Emociones("Neutral", 0.0F, R.color.mustard, neutral))
            graphSad.background = CustomBarDrawable(this, Emociones("Triste", 0.0F, R.color.mustard, sad))
    ...
    fun actualizarGrafica() {
        ...
        lista.add(Emociones("Neutral", pN, R.color.greniee, neutral))
        ...
        graphNeutral.background = CustomBarDrawable(this, Emociones("Neutral", pN, R.color.greniee, neutral))
